...
The objective of this analysis was to evaluate the accuracy of annotated cell type labels using both classical machine learning algorithms and scanVI. The focus is meant to be on clearly documenting the methodology, results, and interpretation.
